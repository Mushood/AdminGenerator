                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row_input">
                                ...
                                <select id="locale" class="form-control" v-model="entitygenerator.locale" :disabled="!edit" @change="getTranslatedIfExists">
...
<script>
    ...
    export default {
        ...
        methods: {
                        ...
                        if (vm.edit) {
                            axios.put(
                                this.$store.state.url + "/api/admin/entitygenerator/" + vm.entitygenerator.slug,
                                {
                                    ...
                                    language: vm.entitygenerator.locale
                                },
                                {
            ...
            loadEntitygenerator(slug, locale = 'en') {
                const vm = this;
                axios.get(
                    this.$store.state.url + "/api/admin/entitygenerator/" + slug + "/" + locale,
                    { 'headers': { 'Authorization': "Bearer " + vm.$store.state.user.token } }
                ).then(response => {
            ...
            getTranslatedIfExists() {
                this.loadEntitygenerator(this.$route.params.slug, this.entitygenerator.locale);
            },
