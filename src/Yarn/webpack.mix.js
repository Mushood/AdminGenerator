...
mix.copy('resources/assets/css/auth.css', 'public/css/auth.css');
mix.copy('resources/assets/css/bootstrap.min.css', 'public/css/bootstrap.min.css');
mix.copy('resources/assets/images/slider-2.jpg', 'public/images/slider.jpg');
mix.copy('resources/assets/images/red.png', 'public/images/red.png');
